    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                {!! Form::open(['route' => ['role.update', $data->id], 'method' => 'PATCH',]) !!}
                ...
                <ul class="mb-3 list-group">
                    ...
                    {!! Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class' => 'form-check-input me-1')) !!}                       
                    {{ $value->name }}
                    </li>
                    @endforeach
                </ul>
