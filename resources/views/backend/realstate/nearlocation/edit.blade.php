...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">Edit Near Location</h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            @endif
                ...
                <hr>
                {!! Form::open(['route' => ['nearlocation.update', $data->id], 'method' => 'PATCH',]) !!}
                ...
                <div class="mb-0 col-md-6">
                    ...
                    <a href="{{ route('nearlocation.index') }}" class="btn btn-outline-danger mb-2">Cancel</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
