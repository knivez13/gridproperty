...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">Create Property Type</h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                {!! Form::open(['route' => 'propertytype.store', 'method' => 'POST']) !!}
                ...
                <div class="mb-0 col-md-6">
                    ...
                    <a href="{{ route('propertytype.index') }}" class="btn btn-outline-danger mb-2">Cancel</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
