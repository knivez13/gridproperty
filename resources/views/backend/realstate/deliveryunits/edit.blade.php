...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">Edit Delivery Units</h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            @endif
                ...
                <hr>
                {!! Form::open(['route' => ['deliveryunits.update', $data->id], 'method' => 'PATCH',]) !!}
                ...
                <div class="mb-0 col-md-6">
                    ...
                    <a href="{{ route('deliveryunits.index') }}" class="btn btn-outline-danger mb-2">Cancel</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
