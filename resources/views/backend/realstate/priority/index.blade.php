...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">Priority List Tables</h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-7">
                        <a href="{{ route('priority.create') }}" class="btn btn-outline-info mb-2"><i class="mdi mdi-plus-circle me-2"></i>Create</a>
                    </div>
                    <div class="col-sm-5">
                ...
                @include('backend.realstate.priority.list')
            </div>
